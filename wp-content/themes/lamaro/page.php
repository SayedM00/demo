...
if ( function_exists( 'FW' ) ) {
	...
	$lamaro_current_scheme_db = fw_get_db_post_option( $wp_query->get_queried_object_id(), 'color-scheme' );
	
	add_filter ('lamaro_current_scheme', function() {
		global $lamaro_current_scheme_db;
		if ($lamaro_current_scheme_db == 'default') $lamaro_current_scheme_db = 1; 
		return $lamaro_current_scheme_db; 
	} );
...
if ( !lamaro_check_active_sidebar() OR lamaro_is_wc('cart') OR lamaro_is_wc('checkout') ) {
