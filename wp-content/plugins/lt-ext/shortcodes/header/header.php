...
*/					
			array(
				...
				'dependency' => array(
					'element' => 'style',
					'value' => array('header-underline', 'header-subheader'),
				),					
			),				
...
//					esc_html__('Theme Icon', 'lt-ext') 						=> 'theme-icon',
					esc_html__('Header with subheader', 'lt-ext') 			=> 'header-subheader',
					esc_html__('Underline Wave', 'lt-ext') 						=> 'header-underline',
