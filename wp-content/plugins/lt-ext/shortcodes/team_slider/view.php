...
if ( $query->have_posts() ) {
	...
	while ( $query->have_posts() ):
		...
		if ( $args['type'] == 'slider' )  {
			...
			echo '<div class="col-lg-4 col-md-6 col-sm-12 col-ms-12">';
		}

			echo '<div class="team-item item item-type-'.esc_attr($atts['type']).' ">';

				echo '<a href="'.get_the_permalink().'" class="image">'.wp_get_attachment_image( get_post_thumbnail_id( get_The_ID()) , 'lamaro-team').'</a>';
